...
```bash
docker build -t vel7an/kf1-docker:CM --build-arg steamU=... --build-arg steamP='...' --build-arg code=... .
```
...
```bash
docker run --rm -it --name kf1-docker-CM -p 0.0.0.0:7707:7707/udp -p 0.0.0.0:7708:7708/udp -p 0.0.0.0:7717:7717/udp -p 0.0.0.0:28852:28852/udp -p 0.0.0.0:28852:28852/tcp -p 0.0.0.0:8075:8075/tcp -p 0.0.0.0:20560:20560/udp -p 0.0.0.0:20560:20560/tcp --env-file=env_file vel7an/kf1-docker:CM
```
